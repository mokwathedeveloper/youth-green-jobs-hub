    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-date'],
                'indexes': [models.Index(fields=['date'], name='analytics_e_date_c676c1_idx'), models.Index(fields=['-date'], name='analytics_e_date_665fe9_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-date'],
                'indexes': [models.Index(fields=['date'], name='analytics_p_date_82cc92_idx'), models.Index(fields=['-date'], name='analytics_p_date_87f269_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['timestamp'], name='analytics_s_timesta_b50180_idx'), models.Index(fields=['-timestamp'], name='analytics_s_timesta_3a7dcb_idx')],
            },
        ),
        migrations.CreateModel(
            name='DashboardAlert',
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['is_active', 'alert_type'], name='analytics_d_is_acti_30b4e0_idx'), models.Index(fields=['category', 'is_active'], name='analytics_d_categor_e763e4_idx'), models.Index(fields=['-created_at'], name='analytics_d_created_0b67b3_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(help_text='User for engagement tracking', on_delete=django.db.models.deletion.CASCADE, related_name='engagement_metrics', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'User Engagement Metrics',
                'verbose_name_plural': 'User Engagement Metrics',
                'ordering': ['-date', 'user'],
                'indexes': [models.Index(fields=['user', 'date'], name='analytics_u_user_id_2064f7_idx'), models.Index(fields=['date'], name='analytics_u_date_aa1b1e_idx'), models.Index(fields=['-date'], name='analytics_u_date_8f3c1d_idx')],
