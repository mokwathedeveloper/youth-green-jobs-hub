    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county', models.CharField(default='Kisumu', help_text='County in Kenya (default: Kisumu)', max_length=50)),
                ...
                ('profile_picture', models.ImageField(blank=True, help_text='Profile picture for user identification', null=True, upload_to='profile_pictures/')),
                ...
                ('verification_document', models.FileField(blank=True, help_text='Identity document for verification (ID, passport, etc.)', null=True, upload_to='verification_documents/')),
